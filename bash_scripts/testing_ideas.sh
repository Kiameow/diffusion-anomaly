...
dataset_path="$script_dir/../data/ideas/testing"
...
SAMPLE_FLAGS="--batch_size 10 --num_samples 1 --timestep_respacing ddim1000 --use_ddim True"

python scripts/classifier_sample_known.py  \
    --data_dir $dataset_path  \
    --model_path ./results/ideas-model.pt \
    --classifier_path ./results/ideas-classifier.pt \
    --dataset ideas \
